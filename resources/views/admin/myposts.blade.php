                                        ...
                                        <div id="my-posts" class="tab-pane fade active show">
                                            <div class="my-post-content pt-3">
                                                ...
                                                <div class="post-input">
                                                    ...
                                                    <a href="{{ url('admin/myprofile') }}" class="btn btn-primary">All Post</a>
                                                    <!--  add Modal -->
                                                ...
                                                <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                    ...
                                                    <a href="{{ url('blog/'.$post->id.'/edit') }}" class="btn btn-primary me-2" ><span class="me-2"
                                                        onclick='getValue(".$id., .$title., .$body.");'><i
                                                                class="fa fa-edit"></i></span>Edit</a>
                                                    <a href="{{ url('blog/delete/'.$post->id) }}" class="btn btn-primary me-2" ><span class="me-2"><i
