                ...
                <ul class="metismenu" id="menu">
                    <li class="dropdown header-profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="{{ url('/admin/myprofile') }}" class="dropdown-item ai-icon">
                            ...
                            <a href="{{ url('admin/change_password') }}" class="dropdown-item ai-icon">
                    ...
                    <li><a class="has-arrow ai-icon" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ url('admin/myprofile') }}">Profile</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" aria-expanded="false">
                            <i>
                                <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary"
                                    width="18" height="18" viewbox="0 0 24 24" fill="grey"
                    ...
                    <li><a class="has-arrow ai-icon"  aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ url('admin/customer')}}">Members</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ url('admin/business_categories')}}">Business Categories</a></li>
                        <li><a href="{{ url('admin/business_types')}}">Business Types</a></li>
                        <li><a href="{{ url('admin/district')}}">Districts</a></li>
                    </ul>
                    </li>
                </ul>
                <div class="copyright">
