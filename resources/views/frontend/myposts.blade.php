                                        ...
                                        <div id="my-posts" class="tab-pane fade active show">
                                            <div class="my-post-content pt-3">
                                                ...
                                                <div class="post-input">
                                                    ...
                                                    <a href="{{ url('frontend/blog') }}" class="btn btn-primary">All Post</a>
                                                    <!--  add Modal -->
                                                    <div class="modal fade" id="postModal">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="{{ url('/frontend/blog/create/post') }}" method="POST">
                                                                    @csrf
                                                                <div class="modal-body">
                                                                    <div>
                                                ...
                                                <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                    ...
                                                    <a class="post-title" href="{{ url('frontend/view/'. $post->id) }}">
                                                    ...
                                                    <a href="{{ url('frontend/blog/'.$post->id.'/edit') }}" class="btn btn-primary me-2" ><span class="me-2"
                                                        onclick='getValue(".$id., .$title., .$body.");'><i
                                                                class="fa fa-edit"></i></span>Edit</a>
                                                    <a href="{{ url('frontend/blog/delete/'.$post->id) }}" class="btn btn-primary me-2" ><span class="me-2"><i
