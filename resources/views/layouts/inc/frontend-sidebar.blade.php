                ...
                <ul class="metismenu" id="menu">
                    <li class="dropdown header-profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="{{ url('frontend/myinfo') }}" class="dropdown-item ai-icon">
                            ...
                            <a href="{{ url('frontend/change_password') }}" class="dropdown-item ai-icon">
                    ...
                    <li><a href="{{ url('frontend/dashboard') }}" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ url('frontend/myinfo') }}">Profile</a></li>
                            <li><a href="{{ url('frontend/change_password') }}">Change Password</a></li>
                            <li><a href="{{ url('frontend/updateprofile') }}">Update Profile</a></li>
                            <li><a href="{{ url('chatify') }}">Messages</a></li>
                        </ul>
                    </li>
                    <li><a href="{{ url('frontend/subscription') }}">
