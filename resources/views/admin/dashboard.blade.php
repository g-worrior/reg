...
@section('content')
                    ...
                    <div class="card bg-warning invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                ...
                                <span class="text-white fs-18">Total Registered Users</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card bg-success invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">{{ $countsubscribers }}</h2>
                                <span class="text-white fs-18">Total Subscribed Users</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card bg-info invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">{{ $countmales }}</h2>
                                <span class="text-white fs-18">Total Males</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card bg-secondary invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">{{ $countfemales }}</h2>
                                <span class="text-white fs-18">Total Females</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-6">
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Area Chart For Registered Members
                        </div>
                ...
                <div class="col-xl-6">
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Bar Chart For Registered Members
                        </div>
    ...
    {{-- charts --}}
    <script src="{{ asset('js/charts/Chart.min.js') }}" crossorigin="anonymous"></script>
    ...
    <script src="{{ asset('js/charts/mylinechart.js') }}"></script>
    <script src="{{ asset('js/charts/mybarchart.js') }}"></script>
