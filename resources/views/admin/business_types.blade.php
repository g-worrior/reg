...
@section('content')
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_type"><i
                                class="fa fa-plus"></i> Add Business Type</a>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ url('admin/typesave') }}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label>Type Name <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="type" name="business_type_name">
                                    </div>
                ...
                <div id="edit_type" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ url('admin/typeupdate') }}" method="POST">
                                    @csrf
                                    <input type="hidden" class="form-control" id="e_id" name="id" value="">
                                    <div class="form-group">
                                        <label>Type Name<span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="e_business_type_name" name="business_type_name"
                                            value="">
                                    </div>
                                    <div class="submit-section">
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="modal-btn delete-action">
                                    <form action="{{ url('admin/typedelete') }}" method="POST">
                                        @csrf
    ...
    <script>
        $(document).on('click', '.edit_type', function() {
            ...
            $('#e_business_type_name').val(_this.find('.business_type_name').text());
        });
    </script>
    {{-- delete model --}}
     <script>
