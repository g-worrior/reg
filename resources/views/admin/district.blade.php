...
@section('content')
                                    ...
                                    <tbody>
                                        @foreach ($districts as $key => $items)
                                            <tr>
                                                ...
                                                <td class="district_name">{{ $items->district_name }}</td>
                                                <td>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ url('admin/districtsave') }}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label>District Name <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="type" name="district_name">
                                    </div>
                ...
                <div id="edit_type" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ url('admin/districtupdate') }}" method="POST">
                                    @csrf
                                    <input type="hidden" class="form-control" id="e_id" name="id" value="">
                                    <div class="form-group">
                                        <label>District Name<span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="e_district_name" name="district_name"
                                            value="">
                                    </div>
                                    <div class="submit-section">
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="modal-btn delete-action">
                                    <form action="{{ url('admin/districtdelete') }}" method="POST">
                                        @csrf
    ...
    <script>
        $(document).on('click', '.edit_type', function() {
            ...
            $('#e_district_name').val(_this.find('.district_name').text());
        });
    </script>
    {{-- delete model --}}
     <script>
