...
<div id="comment-{{ $comment->getKey() }}" class="media">
    <img class="mr-3" src="https://www.gravatar.com/avatar/{{ md5($comment->commenter->profile_picture ?? $comment->guest_email) }}.jpg?s=64" alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar">
