                                            ...
                                            <div class="my-post-content pt-3">
                                                ...
                                                <div class="post-input">
                                                    ...
                                                    <a class="btn btn-primary"
                                                        data-bs-toggle="modal" data-bs-target="#postModal">Add Post</a>
                                                    <a href="{{ url('executive/myprofile') }}" class="btn btn-primary">All Post</a>
                                                    <!--  add Modal -->
                                                    <div class="modal fade" id="postModal">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="{{ url('/blog/create/post') }}" method="POST">
                                                                    @csrf
                                                                <div class="modal-body">
                                                                    <div>
                                                                    ...
                                                                    <button class="btn btn-primary btn-rounded">Post</button>
                                                                </div>
                                                                </form>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                    ...
                                                    <a class="post-title" href="{{ url('executive/view/'.$post->id) }}">
                                                        <p><h3 class="title">{{ $post->title }}
                                                        </h3></p>
                                                    </a>
                                                    ...
                                                    <a href="{{ url('/executive/blog/'.$post->id.'/edit') }}" class="btn btn-primary me-2" ><span class="me-2"
                                                        onclick='getValue(".$id., .$title., .$body.");'><i
                                                                class="fa fa-edit"></i></span>Edit</a>
                                                    <a href="{{ url('/executive/blog/delete/'.$post->id) }}" class="btn btn-primary me-2" ><span class="me-2"><i
                                                                class="fa fa-trash"></i></span>Delete</a>
                                                </div>         
                                                @empty
                                                  <p class="text-warning">You have no blog Posts.</p>
                                                @endforelse 
                                            </div>
                                        </div>
                                        <div id="about-me" class="tab-pane fade">
                                            ...
                                            <div class="profile-personal-info">
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    @foreach ($users as $user)  
                                                        <div class="col-sm-9 col-7"><span>{{ $user->district_name }}</span>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            </div>
...
***********************************-->
    ...
    <script>
        $(document).on('click', '.editModal', function() {
            $('#e_id').val(find('.e_id').text());
            $('#e_title').val(find('.title').text());
            $('#e_body').val(find('.body').text());
        });
    </script>
    {{-- delete model --}}
     <script>
